...
UI_data::UI_data(bool isLight_, const Vec3f& p){
    img.load("C:\\Users\\gimna\\Desktop\\BMSTU\\KG\\Praktika\\Frolov\\programm\\textures\\bricks.jpg");
    isLight = isLight_;
...
{
    QString fileName = QFileDialog::getOpenFileName(this, "Выберите текстуру", "C:\\Users\\gimna\\Desktop\\BMSTU\\KG\\Praktika\\Frolov\\programm\\textures",
                                                    "JPG (*.jpg);;PNG (*.png)");
    QImage img;
