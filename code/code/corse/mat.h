...
public:
    ...
    // Преобразования трехмерной сцены в пространство камеры
    ...
    static Matrix Inverse(const Matrix& m)
    {
        ...
        {
            double Result[4][4];
            double tmp[12]; // временный массив для пар
            double src[16]; // массив транспонированной исходной матрицы
            ...
            // вычислить пары для первых 8 элементов
            tmp[0] = src[10] * src[15];
            tmp[1] = src[11] * src[14];
            tmp[2] = src[9] * src[15];
            tmp[3] = src[11] * src[13];
